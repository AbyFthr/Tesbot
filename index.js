...
//APIKEY
zeksApi = ["L2lD7ElLOYWs2a4IDaOgYB7nv0d"]
...
"listMessage": {
"title": '「 STORE MENU 」',
"description": `*Created By KadekBotz*`,
"buttonText": "𝙋𝙄𝙇𝙄𝙃 𝘿𝙄𝙎𝙄𝙉𝙄",
"listType": "SINGLE_SELECT",
"sections": [
{
...
Lexxy.sendMessage(from, bf, image, { quoted: flexx, caption: 'Logo By KRIS GAMING' })
break
case 'kaneki':
case 'rem':
case 'lolimaker':
...
fakethumb(buffer,'By KRIS GAMING')
fs.unlinkSync(ran)
})
break
case 'searchgrup':
...
Lexxy.sendMessage('6285858939020@s.whatsapp.net', options, text, {quoted: flexx})
Lexxy.sendMessage('6285858939020@s.whatsapp.net', options, text, {quoted: flexx})
